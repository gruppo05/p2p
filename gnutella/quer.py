def quer(self,connection):
    ...
    try:
        ...
        if data is None:
            ...
            self.dbReader.execute("INSERT INTO pacchetto VALUES (PacketId)", (pktid,))
            ...
            #ttl = 1 : rispondo solo io alla richiesta se possibile
            if int(ttl)>1:
                ttl = ttl - 1
                ...
                for v in vicini:
                    if v[n][0] != ipp2p and v[n][1] != pp2p: # rimando il pacchetto a tutti tranne quelli che me lo hanno rimandato
                        self.server_address = ( v[n][0] , v[n][1])
